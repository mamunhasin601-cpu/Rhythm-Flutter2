 ...
 * блокирующая модалка — фикс 14).
 * Молча не переносим: показываем, ЧТО занято, и предлагаем
 * ближайшие свободные окна (список-радио, выбранный подсвечен).
 * «Перенести на HH:MM» — ставим в выбранный слот; «Отмена»/Esc —
 * ничего не меняем. Клик по фону НЕ закрывает (выбор не теряется
 * случайно), страница под модалкой не прокручивается, фокус
 * заперт внутри (useFocusTrap в DialogShell).
 * ============================================================ */
