...
export const PALETTES: Record<
  PaletteId,
  { label: string; swatch: [string, string, string]; map: Partial<Record<TaskColor, string>> }
> = {
  default: { label: "Rhythm", swatch: ["#9D7BFF", "#6C7BFF", "#37D6C0"], map: {} },
  ocean: {
    label: "Океан",
    swatch: ["#5AB8F2", "#4C7DF0", "#37D6C0"],
    map: {
      violet: "#5AB8F2",
      indigo: "#4C7DF0",
      amber: "#7FD1E8",
...
export function resolveColors(
  user: Pick<User, "themePalette" | "customColor"> | null | undefined
): Record<TaskColor, string> {
