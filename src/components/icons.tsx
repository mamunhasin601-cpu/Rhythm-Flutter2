...
const P: Record<IconName, React.ReactNode> = {
  ...
  tag: (
    <>
      <path
        d="M20.6 13.4L12.6 21.4a2 2 0 01-2.8 0L3 14.6V8a2 2 0 012-2h2a2 2 0 012-2h6.6l5 5a2 2 0 010 2.8z"
  ...
  edit: (
    <>
      <path d="M12 20h9" />
      <path d="M16.5 3.5a2.1 2.1 0 013 3L7.5 18.5 3 20l1.5-4.5L16.5 3.5z" />
    </>
  ),
  trash: (
    <>
      <path d="M3.5 6.5h17" />
      <path d="M8.5 6.5v-2a1.5 1.5 0 011.5-1.5h4a1.5 1.5 0 011.5 1.5v2" />
      <path d="M18.5 6.5l-.9 12.6a2 2 0 01-2 1.9H8.4a2 2 0 01-2-1.9L5.5 6.5" />
  ...
  user: (
    <>
      ...
      <path d="M4.5 20.5c.6-3.7 3.6-5.8 7.5-5.8s6.9 2.1 7.5 5.8" />
    </>
  ),
  users: (
    <>
      <circle cx="9" cy="8.5" r="3.4" />
      <path d="M2.8 20c.5-3.3 3-5.2 6.2-5.2s5.7 1.9 6.2 5.2" />
      <path d="M15.5 5.4a3.4 3.4 0 010 6.2" />
      <path d="M17.8 15.1c2 .7 3.2 2.3 3.5 4.9" />
    </>
  ),
  sun: (
    <>
  ...
  chart: (
    <>
      ...
      <path d="M8.5 16.5v-5M13 16.5V7.5M17.5 16.5v-8" />
    </>
  ),
  briefcase: (
    <>
  ...
  book: (
    <>
      <path d="M4 19.5A2.5 2.5 0 016.5 17H20V3.5H6.5A2.5 2.5 0 004 6v13.5z" />
      <path d="M4 19.5A2.5 2.5 0 006.5 22H20v-5" />
    </>
  ),
  dumbbell: (
    <>
      <path d="M4 9.5v5M8 7v10M16 7v10M20 9.5v5M8 12h8" />
    </>
  ),
  home: (
    <>
  ...
  coffee: (
    <>
      <path d="M4.5 9h11v5.5a4 4 0 01-4 4h-3a4 4 0 01-4-4V9z" />
      <path d="M15.5 10h1.7a2.3 2.3 0 010 4.6h-1.7" />
      <path d="M7.5 3.5V6M11 3v3.5" />
    </>
  ),
  heart: (
    <path d="M20.8 5.2a5.3 5.3 0 00-7.6 0L12 6.4l-1.2-1.2a5.3 5.3 0 00-7.6 7.4l1.2 1.2L12 21l7.6-7.2 1.2-1.2a5.3 5.3 0 000-7.4z" />
  ),
  music: (
    <>
  ...
  flame: (
    <path d="M12 2.8s5.5 4.4 5.5 9.4a5.5 5.5 0 01-11 0c0-2.2 1-4.3 2.2-5.7 0 2.2 1 3.3 2.1 3.5-.9-2.3-.6-5 1.2-7.2z" />
  ),
  ...
  external: (
    <>
      <path d="M14 4h6v6" />
      <path d="M20 4l-9 9" />
      <path d="M19 13.5V18a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h4.5" />
    </>
  ),
  alert: (
    <>
  ...
  logout: (
    <>
      <path d="M9.5 21H6a2 2 0 01-2-2V5a2 2 0 012-2h3.5" />
  ...
  download: (
    <>
      <path d="M12 4.5v10M7.8 10.8L12 15l4.2-4.2" />
      <path d="M4.5 19.5h15" />
    </>
  ),
  file: (
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 40 40" aria-hidden="true" className="shrink-0">
      <circle
        ...
        cy="20"
        r="15.5"
        fill={active ? `${c}22` : "rgba(255,255,255,0.03)"}
        stroke={c}
...
export function GoogleG({ size = 17 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#4285F4"
        d="M23.5 12.27c0-.85-.08-1.66-.22-2.45H12v4.64h6.46a5.52 5.52 0 01-2.4 3.63v3h3.88c2.27-2.1 3.56-5.17 3.56-8.82z"
      />
      <path
        fill="#34A853"
      ...
      <path
        fill="#EA4335"
        d="M12 4.77c1.76 0 3.34.6 4.59 1.8l3.44-3.44A11.98 11.98 0 0012 0 12 12 0 001.27 6.61l4.01 3.11C6.22 6.88 8.87 4.77 12 4.77z"
      />
    </svg>
  );
}
